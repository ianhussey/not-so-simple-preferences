...
Article states: "participants (n = 20) rated how appealing, positive, likeable, attractive, and interesting both objects were"
...
Materials acquired from authors list 14 items in the scale.

NB this will always find it to be grim consistent as N participants * N items > 100.
...
- Means can't be assessed using GRIM 
